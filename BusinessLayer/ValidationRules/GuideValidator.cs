...
namespace BusinessLayer.ValidationRules
{
    ...
    {
        public GuideValidator()//kurallar tanımlandı yeni rehber girisi icin
        {
            ...
            RuleFor(x => x.Name).MinimumLength(8).WithMessage("Lütfen 10 karakterden daha uzun bir isim giriniz");
        }
    }
}
